...
public class TimeClient {
    ...
    private List<SocketAddress> remoteHosts;
    private DatagramChannel channel;

    private TimeClient(String[] argv) throws Exception {
        if (argv.length == 0) {
    ...
    private InetSocketAddress receivePacket(DatagramChannel channel, ByteBuffer buffer) throws Exception {
        buffer.clear();
    ...
    public static void main(String[] argv) throws Exception {
        ...
        TimeClient client = new TimeClient(new String[]{
                "10.4.94.27","10.4.94.26","10.4.94.23"
        });
        client.sendRequests();
        client.getReplies();
    }
